...
module.exports = {
    ...
    parseBlocks : function(rows, cols) {
        ...
        return [
            new Block([0, 1, 2], [0, 1, 2]),
            new Block([0, 1, 2], [3, 4, 5]),
            new Block([0, 1, 2], [6, 7, 8]),

            new Block([3, 4, 5], [0, 1, 2]),
            new Block([3, 4, 5], [3, 4, 5]),
            new Block([3, 4, 5], [6, 7, 8]),

            new Block([6, 7, 8], [0, 1, 2]),
            new Block([6, 7, 8], [3, 4, 5]),
            new Block([6, 7, 8], [6, 7, 8]),
        ];
    }
}